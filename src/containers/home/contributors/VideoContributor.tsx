...
export interface VideoContributorProps {
  bio?: string;
  homepage?: string;
  name: string;
  photo?: string;
...
const VideoContributor: FC<VideoContributorProps> = (props: VideoContributorProps) => {
    ...
    <Box mb={60} ml={3} mr={3}>
      ...
      <Text textAlign="center">
        ...
        <Box textAlign="center">
          <Text fontSize={2}>{props.bio}</Text>
        </Box>
      </Text>
    </Box>
  );
...
export default VideoContributor;
